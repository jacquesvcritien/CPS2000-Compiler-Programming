...
\end{lstlisting}
				...
				\begin{figure}[H]
					\centering
			 			\includegraphics[width=0.5\textwidth]{xmltest4.png}
			 			\centering
			...
			\begin{figure}[H]
					\centering
			 			\includegraphics[width=0.5\textwidth]{xmltest5.png}
			 			\centering
...
the type is boolean, the old value is negated and a new value is set to constantValue.
			...
			\pagebreak
				...
				\item \textbf{Test 1}: Containing variable declarations, if statements, print statements, while and for loops.
					...
					\begin{figure}[H]
					\centering
			 			\includegraphics[width=0.7\textwidth]{test32.png}
			 			\centering
			  			\caption{test32.png}
			  			\label{fig:test32}
					\end{figure}
					...
					\item \textbf{Test 33}: Test code given in the specification
										\begin{figure}[H]
					\centering
			 			\includegraphics[width=0.7\textwidth]{test33.png}
			 			\centering
			  			\caption{test33.png}
			  			\label{fig:test33}
					\end{figure}			
